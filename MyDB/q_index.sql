...
CREATE TABLE tbl (
  col1 LONGTEXT,
  INDEX idx1 ((SUBSTRING(col1, 1, 10))) -- 10문자만 추출하는 것을 인덱스로 사용하겠다.
);

desc tbl;

INSERT INTO TBL VALUES('1111111111111111111');
...
-- 함수형 인덱스 적용 확인
EXPLAIN
SELECT * FROM tbl WHERE SUBSTRING(col1, 1, 9) = '123456789'; -- 9문자라 인덱스 적용X
EXPLAIN
SELECT * FROM tbl WHERE SUBSTRING(col1, 1, 10) = '1234567890'; -- 10문자기에 인덱스가 적용 됨

-- Q2. EMP 테이블을 EMP_TEST로 만들어서 내보내자(EXPORT)
DROP TABLE EMP_TEST;
