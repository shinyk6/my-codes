...
-- EMP 테이블에서 UPDATE가 발생한 후 SAL이 이전보다 증가한 경우만
--  EMP_UPDATE_LOG 테이블에 변경 내용을 기록하시오.
...
BEGIN
	IF NEW.SAL> OLD.SAL THEN
	INSERT INTO EMP_UPDATE_LOG(EMPNO, OLD_SAL, NEW_SAL)  VALUES(OLD.EMPNO, OLD.SAL, NEW.SAL);
    END IF;
END;
 //
DELIMITER ;
