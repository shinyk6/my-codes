...
public class d_BitExam {
	...
	public static void bitwiseOperations(int x, int y) {
		...
		System.out.println("AND: " + Integer.toBinaryString(andResult)); 	//2진 출력
		...
		System.out.println("AND (16자리): " + String.format("%16s", Integer.toBinaryString(andResult)).replace(' ', '0'));	//16자리수로 표현 , 공백 0으로 채움
	...
	public static void floatAndDoubleBits(float f, double d) {
		...
		System.out.println("float 이진 표현: " + Integer.toBinaryString(floatBits));	//16진수
	...
	public static void main(String[] args) {
		...
		floatAndDoubleBits(-12.375f, 45.625); //비트연산
		nanHandling();
	}
}
