...
public class MathTest {
	...
	public static void main(String[] args) {
	   ...
	   System.out.println("Math.abs(-23.7) = " + Math.abs(-23.7));
		...
		System.out.println("Math.log(2.718282) = " + Math.log(2.718282));
		System.out.println("Math.log(7.389056) = " + Math.log(7.389056));
		...
		System.out.println("Math.pow(9, .5) = " + Math.pow(9, .5));
