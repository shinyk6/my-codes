...
public class a_VirtualThreadDomainScanner {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (String domain : domains) { //도메인 확인 후 IP출력, 탐색시간
            executor.submit(() -> resolveDomain(domain)); //resolveDomain -핸들링코드(Runnable task)
        }
    ...
    private static void resolveDomain(String domain) {
        ...
        long duration = (System.nanoTime() - startTime) / 1_000_000; //접속 시간 계산
        synchronized (System.out) {
