...
public class AppleTreeCompetitionFX extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        root.setStyle("-fx-padding: 20; -fx-alignment: center; -fx-font-size: 15px;");
    ...
    private void pickApple(String who) {
        while (true) {
            ...
            if (done) {
                Platform.runLater(this::showResultDialog); //현재 내가 가지고 있는 showResultDialog
            	Platform.runLater(this::showResultDialog2); //현재 내가 가지고 있는 showResultDialog
                break;
            }
        }
    }
    private void showResultDialog2() {
        ...
        Alert alert = new Alert(Alert.AlertType.INFORMATION); //메시지 상자 INFORMATION : i 아이콘
    ...
    private void showResultDialog() {
        ...
        Alert alert = new Alert(Alert.AlertType.INFORMATION); //메시지 상자 
        alert.setTitle("게임 결과");
